...
- Codex `exec --json <prompt>`, OpenCode `run --format json <prompt>`, and Antigravity `/Users/songdragon/.local/bin/agy --print <prompt>` execution paths;
- ratatui TUI shell;
